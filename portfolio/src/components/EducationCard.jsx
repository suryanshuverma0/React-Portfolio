...
const EducationCard = ({ title, description, status }) => {
  return (
    <div className="bg-gray-200 dark:bg-neutral-900 rounded-lg flex flex-col gap-3 items-center shadow-xl dark:shadow-glow px-4 py-4 hover:scale-105 delay-100 transition-transform duration-500 max-h-44 h-full">
