...
//   return (
//     <div className="bg-red-500 dark:bg-neutral-900 text-gray-600 dark:text-gray-300 w-1/2 py-2 rounded-none md:rounded-full lg:rounded-full text-sm md:text-md lg:text-sm">
//       <div className="flex justify-between items-center px-4 md:px-6">
//         <button onClick={toggleMenu} className="md:hidden text-lg">
//           {isOpen ? <FaTimes /> : <FaBars />}
//         </button>

//         <ul className="hidden md:flex gap-0 md:gap-0 lg:gap-6 justify-center items-center">
//           {navList.map((navItem) => (
//             <li
//               key={navItem}
