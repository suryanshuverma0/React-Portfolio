...
export const projects_data = [
  ...
  {
    id: 2,
    name: "Multi Election Voting System",
    project_image: voting,

    description:
      "Decentralized, secure, and transparent multi-election voting system on Ethereum blockchain.",
    technology_used: ["React", "Solidity"],
    github_link: "https://github.com/suryanshuverma0/Multi-Election-Voting-System",
    is_deployed: true,
    deployment_url: "https://multi-election-voting-system.netlify.app/"
  },
  {
    id: 3,
    name: "Pixel Studio",
