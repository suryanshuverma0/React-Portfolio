...
//   return (
//     <>
//      <div className="flex flex-col justify-center items-center gap-2 shadow-xl dark:shadow-glow text-black dark:text-white bg-gray-200 dark:bg-neutral-900 w-8/10 max-h-48 h-full">
